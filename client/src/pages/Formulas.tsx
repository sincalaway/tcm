...
export default function Formulas() {
  ...
  return <main className="inner-page"><PageMasthead index="乙 · 经方研读" title="经方详情查询" lead="以出处为锚，以药味为线，在可维护目录中检索并保存阅读线索。" />
    ...
    <FormulaCombinationSimulator formulas={allFormulasQuery.data ?? []} herbs={allHerbsQuery.data ?? []} onSendToDecoction={(ingredients) => { setDecoctionIngredients(ingredients.join("、")); setDecoctionGuideOpen(true); }} />
